...
namespace COMP2007FinalAssingment.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "BrandID,Title,Description,Image")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "BrandID,Title,Description,Image")] Brand brand)
        {
            if (ModelState.IsValid)
            {
