...
namespace COMP2007FinalAssingment.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IngredientID,Title,Image")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IngredientID,Title,Image")] Ingredient ingredient)
        {
            if (ModelState.IsValid)
            {
