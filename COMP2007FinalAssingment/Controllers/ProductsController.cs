...
namespace COMP2007FinalAssingment.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.GoalID = new SelectList(db.Goals, "GoalID", "Title");
            ViewBag.IngredientID = new SelectList(db.Ingredients, "IngredientID", "Title");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProductID,Title,Price,Description,Image,Rating,IngredientID,BrandID,GoalID")] Product product)
        {
            ...
            ViewBag.GoalID = new SelectList(db.Goals, "GoalID", "Title", product.GoalID);
            ViewBag.IngredientID = new SelectList(db.Ingredients, "IngredientID", "Title", product.IngredientID);
            return View(product);
        }
